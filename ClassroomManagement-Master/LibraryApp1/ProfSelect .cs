...
{
    public partial class ProfSelect : Form
    {
        ...
        public ProfSelect(Main parent, String NewText, String NewDescription,
 String NewRec1, String NewRec2, String NewRe3, String NewRec4, String NewRec5)
        ...
        {
            pf.ClassListForm.updateProf("Hicks, Sherry");
            this.Close();
        }
        ...
        private void ProfSelect_Load(object sender, EventArgs e)
        {
