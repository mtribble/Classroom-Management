 ...
 String Note4 = "", String Note5 = "")
        ...
        private void FillFormVariables()
        {
            if (currUser == 0)
            {
                ...
                txtAddress1.Text = "123 Street";
                txtAddress2.Text = "456 Lane";
                txtZip.Text = "78212";
            }
            else if (currUser == 1)
            {
            ...
            else if (currUser == 2)
            {
                ...
                txtID.Text = "5678";
                txtAdministrator.Text = "F";
                txtCellPhone.Text = "2104444444";
                txtDeptID.Text = "3";
                txtEmail.Text = "sample@email.org";
                txtGenderID.Text = "F";
                txtHomePhone.Text = "2105555555";
                txtMI.Text = "K";
                txtNotes.Text = "Just a person.";
                //txtPassword.Text = "password";
                txtUniversityID.Text = "5678";
                txtUsername.Text = "jperson";
                //cbDeptId.SelectedValue = 3;
                bool tmp = pf.UserInEditMode;
                pf.UserInEditMode = true;
                chAdministrator.Checked = true;
                ...
                pf.UserInEditMode = tmp;
                txtAddress1.Text = "123 Lane";
                txtAddress2.Text = "456 Street";
                txtZip.Text = "78212";
                //cbDeptId.Text = "Mathematics";
            }
        }
        ...
        public void EditMode()
        {
            ...
            txtAddress1.BackColor = Color.LightGoldenrodYellow;
            txtAddress2.ReadOnly = false;
            txtAddress2.BackColor = Color.LightGoldenrodYellow;
            txtZip.ReadOnly = false;
            txtZip.BackColor = Color.LightGoldenrodYellow;
